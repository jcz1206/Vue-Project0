...
function(e) {
    ...
    c.prototype.view = function() {
        ...
        e.layer = {
            ...
            alert: function(d, f) {
                var t = new c({ content: d, shadeClose: 0, btn: f || '确定' });
                return t.index
            },
            confirm: function(d, f, g, h) {
            ...
            msg: function(d, f) {
                var t = new c({ content: d, skin: 'msg', shadeClose: 0, time: f.time || 2, anim: f.anim || null, style: f.style || null, className: f.className || null });
                return t.index
            },
            load: function(e, d) {
                var t = new c(e || { type: 2, shadeClose: 0, content: d || null });
                return t.index
            }
        },
